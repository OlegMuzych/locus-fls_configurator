    ...
    config() {
        ...
        var button_menu={
            rows:[
                {
                    cols: [
                        { view: "button", type: "image", image: "../sources/models/image/master.svg", width: 450, height: 300, css: "button_1", id: "master_setup"},
                        {
                            width: 20,
                        },
                        { view: "button", type: "image", image: "../sources/models/image/ingeneer.svg", width: 450, height: 300, css: "button_1", id: "engineering_setup"}
                    ]
                },
                {
                    height: 20,
                ...
                {
                    cols:[
                        { view: "button", type: "image", image: "../sources/models/image/info.svg",  width: 450, height: 300, css: "button_1", id: "reference"},
                        {
                            width: 20,
                        },
                        { view: "button", type: "image", image: "../sources/models/image/konfig.svg",  align: "center", width: 450, height: 300, css: "button_1", id: "application_menu"},
                    ]
                },
    ...
    init(view){
        ...
        $$("temp_compensation_22").attachEvent("onItemClick", (id, e )=>{
            if ($$("temp_compensation_22").getValue()== 1) {
                ...
                $$("master_setup").define("image", "../sources/models/image/master_inverse.svg")
                $$("engineering_setup").define("image", "../sources/models/image/ingeneer_inverse.svg")
                $$("reference").define("image", "../sources/models/image/info_inverse.svg")
                $$("application_menu").define("image", "../sources/models/image/konfig_inverse.svg")
                $$("logo_1").refresh()
                ...
                $$("master_setup").define("image", "../sources/models/image/master.svg")
                $$("engineering_setup").define("image", "../sources/models/image/ingeneer.svg")
                $$("reference").define("image", "../sources/models/image/info.svg")
                $$("application_menu").define("image", "../sources/models/image/konfig.svg")
                $$("logo_1").refresh()
                $$("master_setup").refresh()
                $$("engineering_setup").refresh()
                $$("reference").refresh()
