...
export default class GeneralSettings extends JetView {
                ...
                rows: [
                    {
                        rows: [
                            ...
                            },
                            {
                                ...
                                inputAlign: "center",
                                readonly: true,
                                id: "window_type_software_version_two",
                            },
                        ]
                    },
    ...
    listenerLongData = (longData) => {
        ...
        $$('window_type_software_version_two').setValue(softwareVersion);
    ...
    init() {
        ...
        if (configFile.theme == 'light') {
            ...
            webix.html.addCss($$("window_type_software_version_two").getNode(), "window_type_1");
        ...
        if (configFile.theme == 'dark') {
            ...
            webix.html.addCss($$("window_type_software_version_two").getNode(), "window_type_1_dark");
